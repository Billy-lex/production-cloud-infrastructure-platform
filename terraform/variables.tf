...
variable "nginx_instance_type" {
  description = "EC2 instance type for the Nginx reverse proxy (defaults to instance_type if empty)"
  type        = string
  default     = ""
}

variable "app_instance_type" {
  description = "EC2 instance type for the application server (defaults to instance_type if empty)"
  type        = string
  default     = ""
}
